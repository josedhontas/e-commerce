...
const fixedImageUrl = "https://media-public.canva.com/7o3nc/MAFsqp7o3nc/1/tl.png";
  ...
  try {
    const mousesCategory = await prisma.category.create({
      data: {
        name: "Mouses",
        slug: "mouses",
        imageUrl: "https://media-public.canva.com/OqqIU/MAD5YaOqqIU/1/tl.png",
      },
    });
    ...
    const keyboardsCategory = await prisma.category.create({
      data: {
        name: "Teclados",
        slug: "keyboards",
        imageUrl: "https://media-public.canva.com/fK3RQ/MAECkWfK3RQ/1/tl.png",
      },
    });
    ...
    const headphonesCategory = await prisma.category.create({
      data: {
        name: "Fones",
        slug: "headphones",
        imageUrl: "https://media-public.canva.com/gIke4/MAEtY8gIke4/1/tl.png",
      },
    });
    ...
    const mousepadsCategory = await prisma.category.create({
      data: {
        name: "Mousepads",
        slug: "mousepads",
        imageUrl: "https://media-public.canva.com/Tv8zI/MAE2EGTv8zI/1/tl.png",
      },
    });
    ...
    const monitorsCategory = await prisma.category.create({
      data: {
        name: "Monitores",
        slug: "monitors",
        imageUrl: "https://media-public.canva.com/9hNZs/MAEz0a9hNZs/1/tl.png",
      },
    });
    ...
    const speakersCategory = await prisma.category.create({
      data: {
        name: "Speakers",
        slug: "speakers",
        imageUrl: "https://media-public.canva.com/RL0uk/MAEvQ5RL0uk/1/tl.png",
      },
    });
